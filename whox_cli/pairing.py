...
Usage:
    whox pairing list              # Show all pending + approved users
    whox pairing approve <platform> <code>  # Approve a pairing code
    whox pairing revoke <platform> <user_id> # Revoke user access
    whox pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle whox pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: whox pairing {list|approve|revoke|clear-pending}")
        print("Run 'whox pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'whox pairing list' to see pending codes.\n")
