"""
Cron job scheduling system for WHOX Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    whox gateway install    # Install as a user service
    sudo whox gateway install --system  # Linux servers: boot-time system service
    whox gateway            # Or run in foreground
