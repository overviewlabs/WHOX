...
DEFAULT_DATASETS = [
    ...
    "NousResearch/whox-agent-megascience-sft1",
    "NousResearch/WHOX-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/WHOX-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-whox-agent"
]
