"""
Email platform adapter for the WHOX gateway.

Allows users to interact with WHOX by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "WHOX Agent")
        ...
        msg_id = f"<whox-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
