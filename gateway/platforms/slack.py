...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_whox_home() / "slack_tokens.json"
        ...
        try:
            ...
            @self._app.command("/whox")
            async def handle_whox_command(ack, command):
                await ack()
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        from whox_cli.commands import slack_subcommand_map
