...
version: 1.1.0
author: WHOX Agent (adapted from obra/superpowers)
license: MIT
metadata:
  whox:
...
> **For WHOX:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use WHOX tools to understand the project:
