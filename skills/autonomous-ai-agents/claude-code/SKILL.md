...
metadata:
  whox:
    ...
    related_skills: [codex, whox-agent]
---

# Claude Code

Delegate coding tasks to [Claude Code](https://docs.anthropic.com/en/docs/claude-code) via the WHOX terminal. Claude Code is Anthropic's autonomous coding agent CLI.
