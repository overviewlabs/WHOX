...
metadata:
  whox:
    ...
    related_skills: [claude-code, whox-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the WHOX terminal. Codex is OpenAI's autonomous coding agent CLI.
