...
Built for [WHOX Agent](https://github.com/NousResearch/whox-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/whox-agent/skills/creative/ascii-video`](https://github.com/NousResearch/whox-agent/tree/main/skills/creative/ascii-video) via PR.
