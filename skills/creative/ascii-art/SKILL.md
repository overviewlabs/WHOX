...
```bash
python3 -m pyfiglet "WHOX" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=WHOX&font=Slant" | boxes -d stone
```
