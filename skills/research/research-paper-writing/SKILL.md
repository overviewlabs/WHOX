...
## WHOX Agent Integration

This skill is designed for the WHOX agent. It uses WHOX tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other WHOX skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.whox/plans/` | `skill_view("plan")` |
