...
Config via environment variables:
  ...
  RETAINDB_PROJECT    — Project identifier (default: whox)
"""
...
class RetainDBMemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        return [
            ...
            {"key": "project", "description": "Project identifier", "default": "whox"},
        ]
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        if explicit_project:
            ...
            profile_name = os.path.basename(whox_home) if whox_home else ""
            # Default profile (~/.whox) → "whox"; named profiles → "whox-<name>"
            if profile_name and profile_name != ".whox":
                self._project = f"whox-{profile_name}"
            else:
                self._project = "whox"
