#!/usr/bin/env python3
"""
SWE Runner with WHOX Trajectory Format

A runner that uses WHOX-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the WHOX-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses WHOX-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in WHOX format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches WHOX-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using WHOX-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with WHOX Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses WHOX-Agent's built-in execution environments
    and outputs trajectories in WHOX-Agent format.
    """
    ...
    def _convert_to_whox_format(
        ...
        """
        Convert internal message format to WHOX trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to WHOX trajectory format
        trajectory = self._convert_to_whox_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with WHOX trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with WHOX Trajectory Format")
    print("=" * 60)
