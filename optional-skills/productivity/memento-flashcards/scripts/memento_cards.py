...
Data file: $WHOX_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_WHOX_HOME = Path(os.environ.get("WHOX_HOME", Path.home() / ".whox"))
DATA_DIR = _WHOX_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
