...
4. Name the token (e.g., "WHOX Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.whox/.env`:
...
```bash
CANVAS="python $WHOX_HOME/skills/productivity/canvas/scripts/canvas_api.py"
