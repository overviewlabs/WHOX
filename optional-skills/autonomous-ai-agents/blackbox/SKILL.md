...
version: 1.0.0
author: WHOX Agent (Nous Research)
license: MIT
metadata:
  whox:
...
Delegate coding tasks to [Blackbox AI](https://www.blackbox.ai/) via the WHOX terminal. Blackbox is a multi-model coding agent CLI that dispatches tasks to multiple LLMs (Claude, Codex, Gemini, Blackbox Pro) and uses a judge to select the best implementation.
