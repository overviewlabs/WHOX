...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by WHOX Agent
license: MIT
metadata:
  whox:
...
Helper script path: ~/.whox/skills/blockchain/solana/scripts/solana_client.py
...
python3 ~/.whox/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.whox/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.whox/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.whox/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.whox/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.whox/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
