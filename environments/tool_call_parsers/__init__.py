...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("whox")
        class WHOXToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "whox", "mistral", "llama3_json")
...
from environments.tool_call_parsers.whox_parser import WHOXToolCallParser  # noqa: E402, F401
