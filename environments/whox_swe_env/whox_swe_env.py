"""
WHOXSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser whox
    run-api
    python environments/whox_swe_env.py serve \\
...
class WHOXSweEnv(WHOXAgentBaseEnv):
    ...
    name = "whox-swe"
    env_config_cls = WHOXSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[WHOXSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = WHOXSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepWHOX-3-Llama-3-3B-Preview",
            tool_call_parser="whox",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="whox-swe",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="NousResearch/DeepWHOX-3-Llama-3-3B-Preview",
