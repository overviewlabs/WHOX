...
_WHOX_CORE_TOOLS = [
    ...
    "terminal", "process",
    # File manipulation
    "read_file", "write_file", "patch", "search_files", "app_workspace",
...
TOOLSETS = {
    ...
    "file": {
        ...
        "tools": ["read_file", "write_file", "patch", "search_files", "app_workspace"],
        "includes": []
    },
    ...
    # ==========================================================================
    # Full WHOX toolsets (CLI + messaging platforms)
    #
    ...
    "whox-email": {
        "description": "Email bot toolset - interact with WHOX via email (IMAP/SMTP)",
        "tools": _WHOX_CORE_TOOLS,
        "includes": []
    },
    ...
    "whox-sms": {
        "description": "SMS bot toolset - interact with WHOX via SMS (Twilio)",
        "tools": _WHOX_CORE_TOOLS,
        "includes": []
    },
    ...
    "whox-gateway": {
        ...
        "tools": [],
        "includes": ["whox-telegram", "whox-discord", "whox-whatsapp", "whox-slack", "whox-signal", "whox-homeassistant", "whox-email", "whox-sms", "whox-mattermost", "whox-matrix", "whox-dingtalk", "whox-feishu", "whox-wecom", "whox-webhook"]
    }
}
