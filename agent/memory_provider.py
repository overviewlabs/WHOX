...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - whox_home (str): The active WHOX_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.whox``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "whox").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'whox memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], whox_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'whox memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``whox_home`` is the active WHOX_HOME directory path.
