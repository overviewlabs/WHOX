...
def _get_context_cache_path() -> Path:
    ...
    whox_home = Path(os.environ.get("WHOX_HOME", Path.home() / ".whox"))
    return whox_home / "context_length_cache.yaml"
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets WHOX sends to providers:
